    ...
    <article className="border-border/60 bg-card/80 w-full min-w-0 rounded-3xl border p-6 shadow-sm backdrop-blur-sm">
      <header className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 flex-1">
          <p className="text-muted-foreground text-xs font-medium tracking-[0.4em] uppercase">Signal overview</p>
          <h3 className="text-primary mt-2 text-2xl font-semibold">Critical metrics in one glance</h3>
        </div>
        <p className="text-muted-foreground shrink-0 text-xs font-medium">
          Scores are updated every time you request a check.
        </p>
      </header>
